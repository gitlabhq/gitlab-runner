...
- The container image needs to be able to accept an SSH connection through public-key
  ...
  Please consider that the public key to be used for the SSH connection is automatically
  generated by the Fargate driver and passed to the container via `SSH_PUBLIC_KEY`
