...
This defines the Docker Container parameters. (These paramaters will not be passed to [Docker-in-Docker](https://docs.gitlab.com/ee/ci/docker/using_docker_build.html#use-docker-in-docker))
