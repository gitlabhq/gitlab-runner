...
Introduced in GitLab Runner 15.10, config validation checks the structure of the Runner `config.toml` file. The validator pricing `info` level messages only. 
