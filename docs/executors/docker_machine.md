...
1. Download the [appropriate `docker-machine` binary](https://gitlab.com/gitlab-org/ci-cd/docker-machine/-/releases).
   ...
   executable. For example, to download and install `v0.16.2-gitlab.45`:

   ```shell
   curl -O "https://gitlab-docker-machine-downloads.s3.amazonaws.com/v0.16.2-gitlab.45/docker-machine-Linux-x86_64"
