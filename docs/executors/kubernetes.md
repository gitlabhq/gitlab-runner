...
| `pod_spec` | This setting is in Alpha. Overwrites the pod specification generated by GitLab Runner Manager with a list of configurations set on the pod used to run the CI Job. All the properties listed `Kubernetes Pod Specification` can be set. For more information, see [Overwrite generated pod specifications (Alpha)](#overwrite-generated-pod-specifications-alpha). |
...
To modify the `PodSpec` generated by the GitLab Runner Manager, use the `pod_spec` setting in the `config.toml` file.
