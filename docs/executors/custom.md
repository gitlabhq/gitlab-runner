...
| `after_script`                | [`after_script`](https://docs.gitlab.com/ci/yaml/#after_script) defined from the job. This script is always called even if any of the previous steps failed. |
