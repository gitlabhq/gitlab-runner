...
1. Go to the Runners section of https://gitlab.com/gitlab-org/gitlab-runner/-/settings/ci_cd;
1. Unlock the new Runner by editing its properties and unchecking `Lock to current projects`;
1. Go to the Runners section of https://gitlab.com/gitlab-org/security/gitlab-runner/-/settings/ci_cd;
1. Scroll down to the `Other available runners` section and enable the runner for this project;
1. Lock back again the Runner in https://gitlab.com/gitlab-org/gitlab-runner/-/settings/ci_cd.
