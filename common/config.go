...
type KubernetesConfig struct {
	...
	RequestRetryLimits                                RequestRetryLimits                 `toml:"retry_limits" json:"retry_limits" long:"retry-limits" env:"KUBERNETES_RETRY_LIMITS" description:"How many times each request error or error group is to be retried"`
