...
// NewMockSuspendableExecutor creates a new instance of MockSuspendableExecutor. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewMockSuspendableExecutor(t interface {
	mock.TestingT
	Cleanup(func())
}) *MockSuspendableExecutor {
	mock := &MockSuspendableExecutor{}
	mock.Mock.Test(t)
...
// MockSuspendableExecutor is an autogenerated mock type for the SuspendableExecutor type
type MockSuspendableExecutor struct {
	mock.Mock
}

type MockSuspendableExecutor_Expecter struct {
	mock *mock.Mock
}

func (_m *MockSuspendableExecutor) EXPECT() *MockSuspendableExecutor_Expecter {
	return &MockSuspendableExecutor_Expecter{mock: &_m.Mock}
}

// Resume provides a mock function for the type MockSuspendableExecutor
func (_mock *MockSuspendableExecutor) Resume(ctx context.Context, fields url.Values) error {
	ret := _mock.Called(ctx, fields)
...
// MockSuspendableExecutor_Resume_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Resume'
type MockSuspendableExecutor_Resume_Call struct {
	*mock.Call
}
...
//   - ctx context.Context
//   - fields url.Values
func (_e *MockSuspendableExecutor_Expecter) Resume(ctx interface{}, fields interface{}) *MockSuspendableExecutor_Resume_Call {
	return &MockSuspendableExecutor_Resume_Call{Call: _e.mock.On("Resume", ctx, fields)}
}

func (_c *MockSuspendableExecutor_Resume_Call) Run(run func(ctx context.Context, fields url.Values)) *MockSuspendableExecutor_Resume_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockSuspendableExecutor_Resume_Call) Return(err error) *MockSuspendableExecutor_Resume_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *MockSuspendableExecutor_Resume_Call) RunAndReturn(run func(ctx context.Context, fields url.Values) error) *MockSuspendableExecutor_Resume_Call {
	_c.Call.Return(run)
	return _c
}

// Suspend provides a mock function for the type MockSuspendableExecutor
func (_mock *MockSuspendableExecutor) Suspend(ctx context.Context) (url.Values, error) {
	...
	if returnFunc, ok := ret.Get(0).(func(context.Context) url.Values); ok {
		r0 = returnFunc(ctx)
	} else {
		if ret.Get(0) != nil {
...
// MockSuspendableExecutor_Suspend_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Suspend'
type MockSuspendableExecutor_Suspend_Call struct {
	*mock.Call
}

// Suspend is a helper method to define mock.On call
//   - ctx context.Context
func (_e *MockSuspendableExecutor_Expecter) Suspend(ctx interface{}) *MockSuspendableExecutor_Suspend_Call {
	return &MockSuspendableExecutor_Suspend_Call{Call: _e.mock.On("Suspend", ctx)}
}

func (_c *MockSuspendableExecutor_Suspend_Call) Run(run func(ctx context.Context)) *MockSuspendableExecutor_Suspend_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *MockSuspendableExecutor_Suspend_Call) Return(values url.Values, err error) *MockSuspendableExecutor_Suspend_Call {
	_c.Call.Return(values, err)
	return _c
}

func (_c *MockSuspendableExecutor_Suspend_Call) RunAndReturn(run func(ctx context.Context) (url.Values, error)) *MockSuspendableExecutor_Suspend_Call {
	_c.Call.Return(run)
	return _c
}
...
// SetRuntimeEnvironmentKey provides a mock function for the type MockJobTrace
func (_mock *MockJobTrace) SetRuntimeEnvironmentKey(key string) {
	_mock.Called(key)
	return
}

// MockJobTrace_SetRuntimeEnvironmentKey_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SetRuntimeEnvironmentKey'
type MockJobTrace_SetRuntimeEnvironmentKey_Call struct {
	*mock.Call
}

// SetRuntimeEnvironmentKey is a helper method to define mock.On call
//   - key string
func (_e *MockJobTrace_Expecter) SetRuntimeEnvironmentKey(key interface{}) *MockJobTrace_SetRuntimeEnvironmentKey_Call {
	return &MockJobTrace_SetRuntimeEnvironmentKey_Call{Call: _e.mock.On("SetRuntimeEnvironmentKey", key)}
}

func (_c *MockJobTrace_SetRuntimeEnvironmentKey_Call) Run(run func(key string)) *MockJobTrace_SetRuntimeEnvironmentKey_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 string
		if args[0] != nil {
			arg0 = args[0].(string)
...
func (_c *MockJobTrace_SetRuntimeEnvironmentKey_Call) Return() *MockJobTrace_SetRuntimeEnvironmentKey_Call {
	_c.Call.Return()
	return _c
}

func (_c *MockJobTrace_SetRuntimeEnvironmentKey_Call) RunAndReturn(run func(key string)) *MockJobTrace_SetRuntimeEnvironmentKey_Call {
	_c.Run(run)
	return _c
}
