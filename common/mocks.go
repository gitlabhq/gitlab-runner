...
func (_mock *MockConnector) Connect(ctx context.Context) (io.ReadWriteCloser, error) {
	...
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context) (io.ReadWriteCloser, error)); ok {
		return returnFunc(ctx)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context) io.ReadWriteCloser); ok {
		r0 = returnFunc(ctx)
	} else {
		if ret.Get(0) != nil {
...
func (_c *MockConnector_Connect_Call) Return(readWriteCloser io.ReadWriteCloser, err error) *MockConnector_Connect_Call {
	_c.Call.Return(readWriteCloser, err)
	return _c
}

func (_c *MockConnector_Connect_Call) RunAndReturn(run func(ctx context.Context) (io.ReadWriteCloser, error)) *MockConnector_Connect_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_mock *MockInputExpander) Expand(jobInputs *JobInputs) error {
	ret := _mock.Called(jobInputs)
	...
	var r0 error
	if returnFunc, ok := ret.Get(0).(func(*JobInputs) error); ok {
		r0 = returnFunc(jobInputs)
	} else {
		r0 = ret.Error(0)
	}
	return r0
...
//   - jobInputs *JobInputs
func (_e *MockInputExpander_Expecter) Expand(jobInputs interface{}) *MockInputExpander_Expand_Call {
	return &MockInputExpander_Expand_Call{Call: _e.mock.On("Expand", jobInputs)}
}

func (_c *MockInputExpander_Expand_Call) Run(run func(jobInputs *JobInputs)) *MockInputExpander_Expand_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 *JobInputs
		if args[0] != nil {
			arg0 = args[0].(*JobInputs)
		}
		run(
			arg0,
		)
...
func (_c *MockInputExpander_Expand_Call) RunAndReturn(run func(jobInputs *JobInputs) error) *MockInputExpander_Expand_Call {
	_c.Call.Return(run)
	return _c
}
