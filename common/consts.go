...
const DefaultStoreHealthInterval = 5 * time.Second
const DefaultStoreHealthTimeout = 30 * time.Second
const DefaultStoreStaleTimeout = 3 * time.Hour
const DefaultStoreMaxRetries = 10
