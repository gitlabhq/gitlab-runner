...
func (_m *mockContainerClient) CreateContainer(config *container.Config, hostConfig *container.HostConfig, networkingConfig *network.NetworkingConfig, containerName string) (container.ContainerCreateCreatedBody, error) {
...
func (_m *mockContainerClient) InspectContainer(containerName string) (types.ContainerJSON, error) {
...
func (_m *mockContainerClient) StartContainer(containerID string, options types.ContainerStartOptions) error {
