...
func (_mock *MockManager) Adopt(ctx context.Context, mounts []container.MountPoint) error {
	ret := _mock.Called(ctx, mounts)
	...
	var r0 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, []container.MountPoint) error); ok {
		r0 = returnFunc(ctx, mounts)
	} else {
		r0 = ret.Error(0)
	}
	return r0
...
func (_e *MockManager_Expecter) Adopt(ctx interface{}, mounts interface{}) *MockManager_Adopt_Call {
	return &MockManager_Adopt_Call{Call: _e.mock.On("Adopt", ctx, mounts)}
}
...
func (_c *MockManager_Adopt_Call) RunAndReturn(run func(ctx context.Context, mounts []container.MountPoint) error) *MockManager_Adopt_Call {
	_c.Call.Return(run)
	return _c
}
