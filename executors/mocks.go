...
// NewMockProviders creates a new instance of MockProviders. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewMockProviders(t interface {
	mock.TestingT
	Cleanup(func())
}) *MockProviders {
	mock := &MockProviders{}
...
// MockProviders is an autogenerated mock type for the Providers type
type MockProviders struct {
	mock.Mock
}

type MockProviders_Expecter struct {
	mock *mock.Mock
}

func (_m *MockProviders) EXPECT() *MockProviders_Expecter {
	return &MockProviders_Expecter{mock: &_m.Mock}
}

// All provides a mock function for the type MockProviders
func (_mock *MockProviders) All() iter.Seq2[string, common.ExecutorProvider] {
	ret := _mock.Called()
	...
	var r0 iter.Seq2[string, common.ExecutorProvider]
	if returnFunc, ok := ret.Get(0).(func() iter.Seq2[string, common.ExecutorProvider]); ok {
		r0 = returnFunc()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(iter.Seq2[string, common.ExecutorProvider])
		}
	}
	return r0
}

// MockProviders_All_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'All'
type MockProviders_All_Call struct {
	*mock.Call
}

// All is a helper method to define mock.On call
func (_e *MockProviders_Expecter) All() *MockProviders_All_Call {
	return &MockProviders_All_Call{Call: _e.mock.On("All")}
}

func (_c *MockProviders_All_Call) Run(run func()) *MockProviders_All_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockProviders_All_Call) Return(seq2 iter.Seq2[string, common.ExecutorProvider]) *MockProviders_All_Call {
	_c.Call.Return(seq2)
	return _c
}

func (_c *MockProviders_All_Call) RunAndReturn(run func() iter.Seq2[string, common.ExecutorProvider]) *MockProviders_All_Call {
	_c.Call.Return(run)
	return _c
}

// GetByName provides a mock function for the type MockProviders
func (_mock *MockProviders) GetByName(name string) common.ExecutorProvider {
	...
	var r0 common.ExecutorProvider
	if returnFunc, ok := ret.Get(0).(func(string) common.ExecutorProvider); ok {
		r0 = returnFunc(name)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(common.ExecutorProvider)
		}
	}
	return r0
}

// MockProviders_GetByName_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetByName'
type MockProviders_GetByName_Call struct {
	*mock.Call
}

// GetByName is a helper method to define mock.On call
//   - name string
func (_e *MockProviders_Expecter) GetByName(name interface{}) *MockProviders_GetByName_Call {
	return &MockProviders_GetByName_Call{Call: _e.mock.On("GetByName", name)}
}

func (_c *MockProviders_GetByName_Call) Run(run func(name string)) *MockProviders_GetByName_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 string
		if args[0] != nil {
			arg0 = args[0].(string)
...
func (_c *MockProviders_GetByName_Call) Return(executorProvider common.ExecutorProvider) *MockProviders_GetByName_Call {
	_c.Call.Return(executorProvider)
	return _c
}

func (_c *MockProviders_GetByName_Call) RunAndReturn(run func(name string) common.ExecutorProvider) *MockProviders_GetByName_Call {
	_c.Call.Return(run)
	return _c
}
