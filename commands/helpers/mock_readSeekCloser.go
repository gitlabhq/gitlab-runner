...
type mockConstructorTestingTnewMockReadSeekCloser interface {
	mock.TestingT
	Cleanup(func())
}
...
func newMockReadSeekCloser(t mockConstructorTestingTnewMockReadSeekCloser) *mockReadSeekCloser {
