...
- Bump up runner images version to 0.0.38 [!6567](https://gitlab.com/gitlab-org/gitlab-runner/-/merge_requests/6567)
...
- Replace `curl | bash` commands with safer steps [!6036](https://gitlab.com/gitlab-org/gitlab-runner/-/merge_requests/6036) (Yasssmiine @Yasssmiine-x)
